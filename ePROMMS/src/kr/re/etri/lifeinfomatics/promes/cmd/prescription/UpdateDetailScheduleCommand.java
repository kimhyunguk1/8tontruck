...
public class UpdateDetailScheduleCommand implements Command {

	private String next = "";

	public UpdateDetailScheduleCommand(String next) {
		this.next = next;
	}
	...
	public String execute(HttpServletRequest req) throws CommandException {
		try {
			...
			if (day != null && !day.equals("")) {
				day = day.replaceAll("년 |월 ", "-");
				day = day.replaceAll("일", "");
			}
			String scheduleData = req.getParameter("_scheduleData");
			scheduleData = Util.toString(scheduleData);
			if (scheduleData != null && !scheduleData.equals("")) {
				scheduleData = scheduleData.replaceAll("년 |월 ", "");
				scheduleData = scheduleData.replaceAll("일", "");
			}
			...
			if (scheduleData != null && !scheduleData.equals("")) {
				...
				String[] schedules = scheduleData.split("]");
				ScheduleManager.getInstance().updatSchedules(userId, prescriptionId, hospital, schedules);
			}
