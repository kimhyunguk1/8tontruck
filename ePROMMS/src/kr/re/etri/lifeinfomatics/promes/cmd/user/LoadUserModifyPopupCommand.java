...
public class LoadUserModifyPopupCommand implements Command {

	public LoadUserModifyPopupCommand(String string) {
	...
	public String execute(HttpServletRequest req) throws CommandException {
		...
		try {
			...
			return "home/prescription/modifyUserAndPrescription.jsp";
			//return "home/prescription/modifyUser.jsp";
		} catch (Exception ex) {
			Log.out.error(ex, ex);
