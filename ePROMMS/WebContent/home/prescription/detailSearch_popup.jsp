...
function findUser(){
	...
	if(mainForm._name.value != null && mainForm._name.value != ''){
		...
		var tmpUrl = '/PromesService/PromesServerServlet?cmd=loadUserListPopupPage&_userName=' + tmpName + '&_target=detailResultPage';
...
function searchPrescription(){
	...
	mainForm._loginId.value = opener.getLoginId();
       		...
       		<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<tr>
						...
						<td>&nbsp; <input name="_name" type="text" class="inputbox" size=42 id="_name" onkeydown="javascript:if(event.keyCode==13 || window.event.keyCode ==9){findUser();}" <%if(name != null && !name.equals("")){%> value="<%=Util.toString(name) %>"<%} %> /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>&nbsp; <input name="_id" type="text" class="inputbox" size="42" id="_id" <%if(id != null && !id.equals("")){ %> value="<%=Util.toString(id) %>" <%} %> /></td>
					</tr>
					</table>
					</td>
				</tr>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td>&nbsp; <input name="_prescriptionId" type="text" class="inputbox" size="42" id="_prescriptionId" /></td>
						</tr>
					</table>
					</td>
				</tr>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="96" height="25" bgcolor="#ddebec" class="td_table02">관리시작일</td>
							<td>
						...
						<tr>
							<td width="96" height="25" bgcolor="#ddebec" class="td_table02">관리상태</td>
							<td>&nbsp; <select name="_takenSatus" class="select_white" style="width: 260px">
								...
								<option value="ON">관리중</option>
								<option value="FINISH">관리완료</option>
								<option value="FINISH">관리중단</option>
							</select></td>
						</tr>
					</table>
					</td>
