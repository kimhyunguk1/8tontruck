...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
   <tr>
      <td><img alt="" src="/PromesService/images/prescription/main_title_c.gif">
		  ...
		  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<tr>
					...
					<td width="206" class="td_table08" valign="bottom">&nbsp;<fmt:message key='the_number_of_prescription'/> : <select name="_prescriptionIdSel" class="select_white" style="width:120px" onchange="javascript:changePrescription()">
					<%
					...
					<%if(prescriptionInfo != null){ %>
					<td width="4" valign="middle"><img src="/PromesService/images/common/icon_08.gif" width="4" height="7" id="Image4" border="0" onmouseover="MM_swapImage('Image9','','/PromesService/images/common/bt_list_.gif',1)"/></td>
					<td width="174" class="td_table08" >&nbsp;<fmt:message key='the_pillbox'/> : <%=prescriptionInfo.getPillBox_id() %></td>
					<td width="4" valign="middle"><img src="/PromesService/images/common/icon_08.gif" width="4" height="7" id="Image4" border="0" onmouseover="MM_swapImage('Image9','','/PromesService/images/common/bt_list_.gif',1)"/></td>
					<td width="106" class="td_table08" valign="bottom">&nbsp;<fmt:message key='the_duration_of_medication'/> : <%=prescriptionInfo.getTotalDays() %></td>
					<td width="4" valign="middle"><img src="/PromesService/images/common/icon_08.gif" width="4" height="7" id="Image4" border="0" onmouseover="MM_swapImage('Image9','','/PromesService/images/common/bt_list_.gif',1)"/></td>
					<td width="146" class="td_table08" valign="bottom">&nbsp;<fmt:message key='the_frequency_of_medication'/> : <%=prescriptionInfo.getFrequency() %></td>
					<td>&nbsp;</td>
					<%}else{ %>
					<td width="4" valign="middle"><img src="/PromesService/images/common/icon_08.gif" width="4" height="7" id="Image4" border="0" onmouseover="MM_swapImage('Image9','','/PromesService/images/common/bt_list_.gif',1)"/></td>
					<td width="174" class="td_table08" valign="bottom">&nbsp;<fmt:message key='the_pillbox'/> : </td>
					<td width="4" valign="middle"><img src="/PromesService/images/common/icon_08.gif" width="4" height="7" id="Image4" border="0" onmouseover="MM_swapImage('Image9','','/PromesService/images/common/bt_list_.gif',1)"/></td>
					<td width="106" class="td_table08" valign="bottom">&nbsp;<fmt:message key='the_duration_of_medication'/> : </td>
					<td width="4" valign="middle"><img src="/PromesService/images/common/icon_08.gif" width="4" height="7" id="Image4" border="0" onmouseover="MM_swapImage('Image9','','/PromesService/images/common/bt_list_.gif',1)"/></td>
					<td width="146" class="td_table08" valign="bottom">&nbsp;<fmt:message key='the_frequency_of_medication'/> : </td>
					<td>&nbsp;</td>
					<%} %>
				</tr>
				</table></td>
			...
			<tr>
				...
				<tr>
					<%if(prescriptionInfo != null){ %>
					<td width="4" valign="middle"><img src="/PromesService/images/common/icon_08.gif" width="4" height="7" id="Image4" border="0" onmouseover="MM_swapImage('Image9','','/PromesService/images/common/bt_list_.gif',1)"/></td>
					<td width="206" class="td_table08" valign="bottom">&nbsp;<fmt:message key='the_beginning_date_of_medication'/> : <%=prescriptionInfo.getStartDate() %>
					<td width="4" valign="middle"><img src="/PromesService/images/common/icon_08.gif" width="4" height="7" id="Image4" border="0" onmouseover="MM_swapImage('Image9','','/PromesService/images/common/bt_list_.gif',1)"/></td>
					<td class="td_table08" valign="bottom">&nbsp;<fmt:message key='disease_name'/> : <%=prescriptionInfo.getDisease() %>
					<%}else{ %>
					<td width="4" valign="middle"><img src="/PromesService/images/common/icon_08.gif" width="4" height="7" id="Image4" border="0" onmouseover="MM_swapImage('Image9','','/PromesService/images/common/bt_list_.gif',1)"/></td>
					<td width="206" class="td_table08" valign="bottom">&nbsp;<fmt:message key='the_beginning_date_of_medication'/> : 
					<td width="4" valign="middle"><img src="/PromesService/images/common/icon_08.gif" width="4" height="7" id="Image4" border="0" onmouseover="MM_swapImage('Image9','','/PromesService/images/common/bt_list_.gif',1)"/></td>
					<td class="td_table08" valign="bottom">&nbsp;<fmt:message key='disease_name'/> : 
					<%} %>
				</tr>
				</table></td>
			</tr>
