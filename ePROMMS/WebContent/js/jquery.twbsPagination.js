...
(function ($, window, document, undefined) {
    ...
    TwbsPagination.prototype = {
        ...
        init: function (options) {
        	if(typeof(this.options.startPage) != 'Number'){
        		this.options.startPage = Number(this.options.startPage);
        	}
        	if(typeof(this.options.totalPages) != 'Number'){
        		this.options.totalPages = Number(this.options.totalPages);
        	}
